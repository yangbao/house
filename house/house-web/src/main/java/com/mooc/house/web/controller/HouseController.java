...
//	private CommentService commentService;
	 ...
	 */
	@RequestMapping("/house/list") //query竟然是个house
	...
	public String houseDetail(Long id,ModelMap modelMap){
	    ...
	    HouseUser houseUser = houseService.getHouseUser(id); // 有null 风险
	    recommendService.increase(id); //点一次,热度就会增加1
